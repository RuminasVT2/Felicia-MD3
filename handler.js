...
global.dfail = (type, m, conn) => {
    ...
    if (msg) return conn.reply(m.chat, msg, m, { contextInfo: { externalAdReply: {title: global.wm, body: '⌬ Felicia-MD', sourceUrl: global.snh, thumbnail: fs.readFileSync('./thumbnail.jpg') }}})
